...
:root{--bg:#0C0C0E;--bg2:#131317;--bg3:#1A1A1F;--c1:#E8E4DC;--c2:#B5AFA5;--c3:#8A847A;--gold:#E0B45C;--gold-dim:rgba(224,180,92,0.10);--gold-glow:rgba(224,180,92,0.22);--line:rgba(232,228,220,0.07);--serif:'Instrument Serif',Georgia,serif;--sans:'DM Sans',sans-serif;--r:16px}
.w{max-width:1200px;margin:0 auto;padding:0 20px}.s{padding:44px 0}
.nv{position:fixed;top:0;left:0;right:0;z-index:100;padding:12px 0;background:rgba(12,12,14,0.88);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);border-bottom:1px solid var(--line)}
.nv .w{display:flex;justify-content:space-between;align-items:center}
.nl{font-family:var(--serif);font-size:1.2rem;text-decoration:none;color:var(--c1);z-index:102;position:relative}.nl span{color:var(--gold)}
.nm{display:none}
.nb{background:none;border:none;cursor:pointer;width:22px;height:16px;position:relative;z-index:102;-webkit-tap-highlight-color:transparent}
.nb span{display:block;width:100%;height:2px;background:var(--c1);position:absolute;left:0;transition:all .3s}
.nb span:nth-child(1){top:0}.nb span:nth-child(2){top:7px}.nb span:nth-child(3){top:14px}
.nb.on span:nth-child(1){top:7px;transform:rotate(45deg)}.nb.on span:nth-child(2){opacity:0}.nb.on span:nth-child(3){top:7px;transform:rotate(-45deg)}
.no{display:none;position:fixed;inset:0;z-index:101;background:rgba(12,12,14,0.98);flex-direction:column;justify-content:center;align-items:center;gap:24px}
.no.on{display:flex}.no a{color:var(--c2);text-decoration:none;font-size:1.1rem;letter-spacing:.04em;text-transform:uppercase;transition:color .3s}.no a:hover{color:var(--gold)}
.pl{background:var(--gold)!important;color:var(--bg)!important;padding:11px 26px;border-radius:100px;font-weight:500;text-transform:none!important;font-size:.95rem!important}
.bg{display:inline-flex;align-items:center;justify-content:center;gap:8px;background:var(--gold);color:var(--bg);padding:13px 26px;border-radius:100px;text-decoration:none;font-weight:500;font-size:.92rem;transition:transform .3s,box-shadow .3s;border:none;cursor:pointer}.bg:hover{transform:translateY(-2px);box-shadow:0 8px 24px var(--gold-glow)}
.bo{display:inline-flex;align-items:center;justify-content:center;gap:8px;background:transparent;color:var(--c1);padding:13px 26px;border-radius:100px;text-decoration:none;font-size:.92rem;border:1px solid rgba(232,228,220,0.18);transition:all .3s}.bo:hover{border-color:var(--gold);color:var(--gold)}
...
.hr-ph::after{content:'';position:absolute;inset:0;border-radius:var(--r);background:linear-gradient(180deg,transparent 50%,rgba(12,12,14,.5));pointer-events:none}
.bd{position:absolute;background:var(--bg3);border:1px solid var(--line);border-radius:10px;padding:8px 14px;z-index:2;pointer-events:none}
.bd-l{font-size:.55rem;text-transform:uppercase;letter-spacing:.1em;color:var(--c3)}.bd-v{font-family:var(--serif);font-size:1rem;color:var(--gold)}.bd-a{bottom:-10px;left:-6px}
...
<div class="bd-y"><span class="n">18+</span><span class="l">Years in Product</span></div>
</div></div></div></section>

<div class="st-bar"><div class="w"><div class="st-r">
...
<div class="ti"><div class="td">2018 – 2019</div><h3>Senior Product Manager</h3><h4>VCA Animal Hospitals, Denver, CO</h4><p>Scrum teams delivering apps across 800+ hospitals. Roadmap ownership for myVCA, Retriever+, and Messenger. Training for 20,000+ employees.</p></div>
<div class="ti"><div class="td">2009 – 2018</div><h3>Product &amp; Training Leader</h3><h4>VCA Animal Hospitals, North America</h4><p>Nine years, from Program Leader to Product Manager. Recruited by the COO to design a training program that reversed a 30% revenue decline to 3% growth. Trained teams across 18 states, onboarded 75+ locations. Grew product adoption from 3% to 50%+.</p></div>
</div>
<div class="an" style="margin-top:40px"><div class="se">Education</div><h2 class="sh2" style="margin-bottom:20px">Where it <em>started</em></h2>
<div class="eg"><div class="ec"><div class="ed">Master of Arts, Global Finance &amp; Trade</div><div class="es">University of Denver, Korbel School</div><div class="edt">Economic Integration · International Business · Homeland Security</div></div>
<div class="ec"><div class="ed">Bachelor of Science, Business Information Technology</div><div class="es">University of Denver, Daniels College of Business</div><div class="edt">International Business</div></div></div>
<div class="ex"><span class="et">Fluent in English &amp; Arabic</span><span class="et">Basic French</span><span class="et">Mars Global Innovation Award</span></div>
...
<div class="tg">
<div class="tc an"><blockquote>"I am proud of the profound impact Abe has had on VCA and me. He has such a passion and dedication towards anything he does. Anyone would be lucky to have him as part of their organization."</blockquote><div class="tw"><div class="ta">BA</div><div><div class="tn">Bob Antin</div><div class="tr">CEO &amp; Founder, VCA</div></div></div></div>
<div class="tc an d1"><blockquote>"An exceptional IT product leader who truly stands out for his innovative thinking, strategic vision, and unwavering passion. Abe approaches every challenge with a big-picture mindset, ensuring solutions position the business for future success."</blockquote><div class="tw"><div class="ta">AF</div><div><div class="tn">Aaron Frazier</div><div class="tr">COO, North America</div></div></div></div>
<div class="tc an d2"><blockquote>"Abe is a special leader that leads with both his head and heart. In my years working with him, I've known him to be someone who knew how to advance difficult work forward, while also having those around him feel great about the experience. In short, he is smart, capable, and understands the human element of what it means to be on teams and be a servant leader."</blockquote><div class="tw"><div class="ta">GL</div><div><div class="tn">Garrett Lewis</div><div class="tr">Chief Executive, Vet Services, Greencross Pet Wellness</div></div></div></div>
<div class="tc an d3"><blockquote>"Abe has brought a collaborative, client-centric approach to each engagement. His down-to-earth, approachable demeanor makes him relatable to stakeholders at a variety of levels, and a fun person to have on a team."</blockquote><div class="tw"><div class="ta">MS</div><div><div class="tn">Martha Smith</div><div class="tr">Chief Client Officer</div></div></div></div>
<div class="tc an d4"><blockquote>"Abe has the ability to cut through the noise, make the right trade-offs, and deliver maximum value. He led the product development and launch of 4 mobile apps at a rate that would impress even the most aggressive start-up teams."</blockquote><div class="tw"><div class="ta">BL</div><div><div class="tn">Brendan Lynch</div><div class="tr">SVP, Product &amp; Innovation</div></div></div></div>
</div></div></section>

<section id="contact" class="s ct"><div class="w"><div class="an">
