...
.nav .wrap { display:flex; justify-content:space-between; align-items:center; overflow:visible; }
...
<nav class="nav"><div class="wrap">
  ...
  <div class="nav-menu">
    ...
    <a href="#contact" class="pill">Let's Connect</a>
  </div>
...
<section class="hero sec"><div class="wrap"><div class="hero-inner">
  <div>
    ...
    <p class="hero-desc">I'm Ibrahim Al-Murjan. I build digital products and the organizations behind them. My consumer apps reach 2M+ users. My internal AI tools have processed 1.5M+ clinical dictations. I've built and led a 62-person global team across product, design, engineering, and operations — shipping across 2,500+ locations in North America, Europe, and Asia.</p>
    <div class="hero-btns">
...
<section id="about" class="sec"><div class="wrap"><div class="about-inner">
  <div class="ab an">
    ...
    <p>Since then I've gone from program leader to Global VP of Product, building a 62-person team across product, design, engineering, and operations. I own a $150M+ annual portfolio spanning consumer apps, AI-powered clinical tools for our veterinary staff, telehealth, and enterprise workflow systems across 2,500+ locations globally. I've shipped products in as little as 6 weeks and scaled them to millions of users.</p>
  ...
  <div class="an d2"><div class="sk">
    <div class="skc"><div class="ski">⚡</div><h4>0 → 1 Launches</h4><p>Multiple products from concept to production — including an AI dictation tool for veterinary staff shipped in 6 weeks.</p></div>
    ...
    <div class="skc"><div class="ski">↗</div><h4>Global Scale</h4><p>Products deployed across 2,500+ locations in North America, Europe, and Asia serving millions of end users.</p></div>
    <div class="skc"><div class="ski">◉</div><h4>AI in Production</h4><p>Shipped AI dictation, triage, and decision-support tools for clinical staff — with human-in-the-loop safeguards in regulated healthcare.</p></div>
  </div></div>
</div></div></section>
...
<section id="portfolio" class="sec pf-sec"><div class="wrap">
  ...
  <!-- Scribe AI -->
  <div class="pc an"><div class="pt"><div class="ptag">AI-Powered Internal Tool</div><h3>AI Medical Dictation</h3><p>Custom-built AI dictation tool for our veterinary staff that replaced manual medical record writing. Veterinarians dictate, the system transcribes and pushes structured SOAP notes directly into the practice management system. Cut documentation time by 90%, drove a 30% increase in clinical efficiency, and went from concept to production in 6 weeks. Over 1.5M dictations processed — one of the first production AI tools in veterinary medicine.</p><div class="pn"><div><span class="v">1.5M+</span><span class="l">Dictations Processed</span></div><div><span class="v">30%</span><span class="l">Efficiency Gain</span></div><div><span class="v">6 wks</span><span class="l">Concept to Launch</span></div></div></div>
...
<section id="experience" class="sec"><div class="wrap">
  ...
  <div class="tl an">
    <div class="ti">
      ...
      <p>Leading strategy and delivery of a global digital product platform across 2,500+ hospitals and 70,000+ associates in North America, Europe, and Asia. Managing a $150M+ annual portfolio with a 62-person global team across product, design, engineering, and operations. Driving AI integration across clinical and commercial workflows, cutting administrative workload by 30%. Rebuilt the global product organization, introduced agile delivery, and established cross-regional governance.</p>
    </div>
    <div class="ti">
      <div class="td">2021 — 2024</div>
      <h3>Vice President, Digital Product</h3>
      <h4>VCA Inc — Santa Monica, CA</h4>
      <p>Directed digital transformation for 1,200+ hospitals, improving the care experience for 5 million clients. Built product and engineering departments from the ground up with clear KPIs. Managed budgets and grew the product team to meet increasing scale and complexity. Delivered product strategy keynotes to executive leadership.</p>
    </div>
    <div class="ti">
    ...
    <div class="ti">
      ...
      <p>Progressed from Program Leader to Product Manager over 9 years, leading digital transformation, training, and adoption initiatives across a 500-hospital network. Recruited by the COO/Co-Founder to design a management training program that reversed a 30% revenue decline to 3% growth at a pilot hospital. Trained teams across 18 states, onboarding 75+ locations. Pitched and led digital transformation partnerships, accelerating release cycles from annual to 3-week sprints. Grew product adoption from 3% to 50%+ network-wide.</p>
    </div>
  </div>
...
<!-- ========== CTA ========== -->
<section id="contact" class="sec cta"><div class="wrap"><div class="an">
